...
public class BloodMoon extends LunarEvent {
    ...
    public BloodMoon(LunarEventClientSettings clientSettings, boolean superMoon, int minNumberOfNightsBetween, double chance, Collection<Integer> validMoonPhases) {
