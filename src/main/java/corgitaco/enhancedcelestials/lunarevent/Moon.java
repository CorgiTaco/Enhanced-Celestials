...
public class Moon extends LunarEvent {
    ...
    public Moon() {
        super(new MoonClientSettings(new ColorSettings("", 0, "", 0)), false, 0, 0, Util.make(new IntArraySet(), (set) -> IntStream.rangeClosed(0, 7).forEach(set::add)), CustomTranslationTextComponent.DEFAULT, CustomTranslationTextComponent.DEFAULT);
    }
