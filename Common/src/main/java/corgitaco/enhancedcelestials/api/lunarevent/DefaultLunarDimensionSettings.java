...
public class DefaultLunarDimensionSettings {
    ...
    public static final Holder<LunarDimensionSettings> OVERWORLD_LUNAR_SETTINGS = createEvent("overworld", () -> new LunarDimensionSettings(Util.make(new IdentityHashMap<>(), map -> {
        map.put(DefaultLunarEvents.BLOOD_MOON, new LunarDimensionSettings.Entry(0.1, 4));
        map.put(DefaultLunarEvents.SUPER_BLOOD_MOON, new LunarDimensionSettings.Entry(0.05, 20));
        map.put(DefaultLunarEvents.HARVEST_MOON, new LunarDimensionSettings.Entry(0.1, 4));
