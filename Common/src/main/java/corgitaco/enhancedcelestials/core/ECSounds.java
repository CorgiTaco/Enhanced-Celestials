...
public class ECSounds {
    ...
    public static Supplier<SoundEvent> createSound(String location) {
        ...
        return RegistrationService.INSTANCE.register((net.minecraft.core.Registry<SoundEvent>) Registries.SOUND_EVENT, location, () -> SoundEvent.createVariableRangeEvent(soundLocation));
    }
