...
public class ECStructureSets {
    ...
    public static final Holder<StructureSet> VOLCANOES = register("volcanoes", () -> new StructureSet(List.of(StructureSet.entry(ECStructures.CRATER)), new RandomSpreadStructurePlacement(150, 60, RandomSpreadType.LINEAR, 98778678)));
