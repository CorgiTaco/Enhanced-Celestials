...
import dev.corgitaco.enhancedcelestials.util.CodecUtil;
...
public record MobEffectInstanceBuilder(MobEffect effect, int duration, int amplifier, boolean ambient, boolean visible,
    ...
    public MobEffectInstance makeInstance() {
        return new MobEffectInstance(BuiltInRegistries.MOB_EFFECT.wrapAsHolder(this.effect), this.duration, this.amplifier, this.ambient, this.visible, this.showIcon);
    }
}
