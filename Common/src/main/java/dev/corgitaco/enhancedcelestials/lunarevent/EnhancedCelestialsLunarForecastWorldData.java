...
public class EnhancedCelestialsLunarForecastWorldData extends SyncedLevelTrackedData implements TickableTrackedData {
    ...
    public @Nullable CompoundTag save() {
        ...
        compoundTag.put("forecast", LunarEventInstance.LIST_CODEC.encodeStart(NbtOps.INSTANCE, this.forecast).getOrThrow());
        compoundTag.put("pastEvents", LunarEventInstance.LIST_CODEC.encodeStart(NbtOps.INSTANCE, this.pastEvents).getOrThrow());
    ...
    public void load(CompoundTag tag) {
        this.forecast.clear();
        this.forecast.addAll(LunarEventInstance.LIST_CODEC.decode(NbtOps.INSTANCE, tag.get("forecast")).getOrThrow().getFirst());

        this.pastEvents.clear();
        this.pastEvents.addAll(LunarEventInstance.LIST_CODEC.decode(NbtOps.INSTANCE, tag.get("pastEvents")).getOrThrow().getFirst());
