...
public class CustomTranslationTextComponent {
    ...
    public CustomTranslationTextComponent(String translationKey, Style style, CustomTranslationTextComponent... args) {
        ...
        this.component = Component.translatable(translationKey, Arrays.stream(args).map(customTranslationTextComponent -> customTranslationTextComponent.component).toArray()).withStyle(style);
    }
